...
# Property Of VASHU Indian Largest Support Group
# Rocks © @MENTION_VASHU_BOT © VASHU
# Owner VASHU + MENTION_VASHU_BOT 
...
async def start(event):
    ...
    await event.client.send_file(
        event.chat_id,
        file="https://telegra.ph/file/6368cf50226f851cf12b0.jpg",
        caption="━━━━━━━━━━━━━━━━━━━━━━━━\n\n✪ ɪ ᴀᴍ ᴀʟᴇxᴀ ᴛᴏ ᴍᴇɴᴛɪᴏɴ ᴀʟʟ ᴛʜᴇ ɢʀᴏᴜᴘ ᴍᴇᴍʙᴇʀs ɪɴ ᴛᴇʟᴇɢʀᴀᴍ\n✪ ᴛʜᴀɴᴋs ғᴏʀ ᴜsɪɴɢ ʀᴜɴ /help..\n\n┏━━━━━━━━━━━━━━━━━┓\n┣★ ᴏᴡɴᴇʀ    : [𝙑𝘼𝙎𝙃𝙐 X 𝐌𝐄𝐍𝐓𝐈𝐎𝐍](https://t.me/@MENTION_VASHU_BOT)\n┣★ ᴜᴘᴅᴀᴛᴇs › : [ VASHU ʜᴇʟᴘ](https://t.me/ALL_BOTS_SUPPORT1)┓\n┣★ ʀᴇᴘᴏ › : [ʙʀᴀɴᴅᴇᴅ ʀᴇᴘᴏ](https://github.com/Vashu2456/Vashu-X-Mention)\n┗━━━━━━━━━━━━━━━━━┛\n\n💞 ɪғ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ǫᴜᴇsᴛɪᴏɴs ᴛʜᴇɴ\nᴅᴍ ᴛᴏ ᴍʏ [ᴏᴡɴᴇʀ](https://t.me/Vashu23456) ...\n\n━━━━━━━━━━━━━━━━━━━━━━━━",
        link_preview=False,
        buttons=[
            [Button.url("❤️‍🔥 ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ 💫", "https://t.me/@MENTION_VASHU_BOT?startgroup=true")],
            [Button.url("❤️‍🔥 ɢʀᴏᴜᴘ 💫", "https://t.me/ALL_BOTS_SUPPORT1"), Button.url("❤️‍🔥 ᴄʜᴀɴɴᴇʟ 💫", "https://t.me/Vashu56789")],
            [Button.url("❤️‍🔥 ʜᴇʀᴜᴋᴏ ᴄᴄ 💫", "https://https://t.me/+nCU79TSRF24yMzNl"), Button.url("❤️‍🔥 VASHU ❤️‍🔥", "https://t.me/Vashu23456")]
        ]
    )
...
async def help(event):
    ...
    await event.reply(
        ...
        buttons=(
            [
                Button.url("❤️‍🔥 ꜱᴜᴘᴘᴏʀᴛ 💫", "https://t.me/ALL_BOTS_SUPPORT1"),
                Button.url("❤️‍🔥 ʏᴏᴜᴛᴜʙᴇ 💫", "https://youtube.com/@404xvahugamerfixer"),
            ]
        ),
    )
...
async def help(event):
    ...
    await event.reply(
        ...
        buttons=(
            [
                Button.url("❤️‍🔥 ꜱᴜᴘᴘᴏʀᴛ 💫", "https://t.me/ALL_BOTS_SUPPORT1"),
                Button.url("❤️‍🔥 ʏᴏᴜᴛᴜʙᴇ 💫", "https://youtube.com/Trickyvashu"),
            ]
        ),
    )
...
print(">> VASHU X ᴍᴇɴᴛɪᴏɴ BOT WORKING <<")
...
# Property Of VASHU Indian Largest Support Group
# Rocks © @MENTION_VASHU_BOT © VASHU
# Owner VASHU + MENTION_VASHU_BOT +  VASHU SUPPORT CHAT 
